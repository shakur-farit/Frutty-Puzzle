...
public partial class GameEntity {
    ...
    public Code.Gameplay.Input.CameraComponent camera { get { return (Code.Gameplay.Input.CameraComponent)GetComponent(GameComponentsLookup.Camera); } }
    ...
    public GameEntity AddCamera(UnityEngine.Camera newValue) {
        ...
        var component = (Code.Gameplay.Input.CameraComponent)CreateComponent(index, typeof(Code.Gameplay.Input.CameraComponent));
