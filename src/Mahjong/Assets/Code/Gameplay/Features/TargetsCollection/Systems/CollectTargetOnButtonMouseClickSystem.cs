...
{
	public class CollectTargetOnButtonMouseClickSystem : IExecuteSystem
	{
		...
		public CollectTargetOnButtonMouseClickSystem(GameContext game, IPhysicsService physicsService)
		{
